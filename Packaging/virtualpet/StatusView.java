...
public class StatusView extends JPanel implements Observer {
    ...
    private void initComponents() {
        ...
        progressBarHygiene.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Blank.png"))); // NOI18N
        ...
        progressBarHealth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Blank.png"))); // NOI18N
        ...
        progressBarHunger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Blank.png"))); // NOI18N
        ...
        progressBarHappiness.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Blank.png"))); // NOI18N
    ...
    public void calculateHungerStatus() {
        ...
        if (animal.getHunger()==100)
            this.progressBarHunger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar100.png")));
        else if (animal.getHunger()>=85)
            this.progressBarHunger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar80.png")));
        else if (animal.getHunger()>=70)
            this.progressBarHunger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar60.png")));
        else if (animal.getHunger()>=35)
            this.progressBarHunger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar40.png")));
        else if (animal.getHunger()>=0)
            this.progressBarHunger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar20.png")));
        else
            this.progressBarHunger.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Blank.png")));
    }
    ...
    public void calculateHappinessStatus() {
        ...
        if (animal.getHappiness()==100)
            this.progressBarHappiness.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar100.png")));
        else if (animal.getHappiness()>=85)
            this.progressBarHappiness.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar80.png")));
        else if (animal.getHappiness()>=70)
            this.progressBarHappiness.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar60.png")));
        else if (animal.getHappiness()>=35)
            this.progressBarHappiness.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar40.png")));
        else if (animal.getHappiness()>=0)
            this.progressBarHappiness.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar20.png")));
        else
            this.progressBarHappiness.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Blank.png")));
    }
    
    public void calculateHygieneStatus() {
        this.tHygieneIndex.setText("Hygiene: " + this.animal.getHygiene());
        if (animal.getHygiene()==100)
            this.progressBarHygiene.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar100.png")));
        else if (animal.getHygiene()>=85)
            this.progressBarHygiene.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar80.png")));
        else if (animal.getHygiene()>=70)
            this.progressBarHygiene.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar60.png")));
        else if (animal.getHygiene()>=35)
            this.progressBarHygiene.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar40.png")));
        else if (animal.getHygiene()>=0)
            this.progressBarHygiene.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar20.png")));
        else
            this.progressBarHygiene.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Blank.png")));
    }
    
    public void calculateHealthStatus() {
      this.tHealthIndex.setText("Health: " + this.animal.getHealth());
        if (animal.getHealth()==100)
            this.progressBarHealth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar100.png")));
        else if (animal.getHealth()>=85)
            this.progressBarHealth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar80.png")));
        else if (animal.getHealth()>=70)
            this.progressBarHealth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar60.png")));
        else if (animal.getHealth()>=35)
            this.progressBarHealth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar40.png")));
        else if (animal.getHealth()>=0)
            this.progressBarHealth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Bar20.png")));
        else
            this.progressBarHealth.setIcon(new javax.swing.ImageIcon(getClass().getResource("/virtualpet/design/Status/Blank.png")));
    }
}
